...
def get_columns():
    return [
        {"label": _("Student ID"), "fieldname": "student_id", "fieldtype": "Link", "options": "Customer", "width": 140},
        {"label": _("Student Name"), "fieldname": "student_name", "fieldtype": "Data", "width": 200},
        {"label": _("Student Type"), "fieldname": "custom_student_type", "fieldtype": "Data", "width": 120},
        {"label": _("Faculty"), "fieldname": "custom_faculty", "fieldtype": "Data", "width": 180},
        {"label": _("Department"), "fieldname": "custom_department", "fieldtype": "Data", "width": 180},
        {"label": _("Programme"), "fieldname": "custom_program_of_study", "fieldtype": "Data", "width": 150},
        {"label": _("Year of Study"), "fieldname": "custom_level", "fieldtype": "Data", "width": 110},
        {"label": _("Campus"), "fieldname": "custom_campus", "fieldtype": "Data", "width": 130},
        {"label": _("Email"), "fieldname": "email_id", "fieldtype": "Data", "width": 180},
        {"label": _("Balance (KES)"), "fieldname": "balance", "fieldtype": "Currency", "width": 140},
        {"label": _("Balance Type"), "fieldname": "balance_type", "fieldtype": "Data", "width": 120},
    ]
...
def get_summary(data):
    ...
    return [
        {"label": _("Total Students"), "value": len(data), "datatype": "Int"},
        {"label": _("Overpaid Students"), "value": len(overpaid), "datatype": "Int"},
        {"label": _("Total Overpaid Amount"), "value": sum(flt(r.balance) for r in overpaid), "datatype": "Currency", "currency": "KES"},
        {"label": _("Zero Balance Students"), "value": len(zero), "datatype": "Int"},
        {"label": _("Outstanding Students"), "value": len(outstanding), "datatype": "Int"},
        {"label": _("Total Outstanding Amount"), "value": sum(flt(r.balance) for r in outstanding), "datatype": "Currency", "currency": "KES"},
    ]